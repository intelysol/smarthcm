...
<head>
    ...
    <title>@yield('title', 'My Team — Manager Workspace') — SmartHCM Enterprise</title>
...
<body class="bg-[#F7F9FC] text-[#1F2937] min-h-screen flex flex-col font-sans antialiased">
    ...
    @include('components.shells.header', [
        'currentWorkspace' => \App\Domains\Shared\Enums\WorkspaceType::MANAGER,
    ...
    <x-ui.command-palette currentWorkspace="manager" />
    <x-ui.notification-drawer />
    <x-ui.mobile-nav currentWorkspace="manager" />

    <footer class="border-t border-slate-200 bg-white py-4 text-center text-xs text-slate-500 hidden md:block">
        Manager Workspace &bull; Team Leadership &bull; SmartHCM Platform
    </footer>
</body>
</html>

...
<head>
    ...
    <title>@yield('title', 'Workforce Intelligence') — SmartHCM Executive</title>
...
<body class="bg-[#0F172A] text-slate-100 min-h-screen flex flex-col font-sans antialiased">
    ...
    @include('components.shells.header', [
        'currentWorkspace' => \App\Domains\Shared\Enums\WorkspaceType::EXECUTIVE,
    ...
    <x-ui.command-palette currentWorkspace="executive" />
    <x-ui.notification-drawer />

    <footer class="border-t border-slate-800 bg-[#0B1120] py-4 text-center text-xs text-slate-500">
        SmartHCM Executive &bull; Strategic Workforce Intelligence & Analytics
    </footer>
</body>
</html>

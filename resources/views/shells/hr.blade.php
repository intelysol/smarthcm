...
<head>
    ...
    <title>@yield('title', 'HR Operations Workspace') — SmartHCM Enterprise</title>
...
<body class="bg-[#F7F9FC] text-[#1F2937] min-h-screen flex flex-col font-sans antialiased">
    ...
    @include('components.shells.header', [
        'currentWorkspace' => \App\Domains\Shared\Enums\WorkspaceType::HR_ADMIN,

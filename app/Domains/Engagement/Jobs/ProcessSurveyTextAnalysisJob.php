...
class ProcessSurveyTextAnalysisJob implements ShouldQueue
{
    ...
    public function handle(EngagementTextAnalysisService $textService): void
    {
        ...
        if ($campaign) {
            $textService->analyzeCampaignComments($campaign);
        }
    }
}

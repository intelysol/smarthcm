...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('rule_executions', 'trace')) {
        ...
        if (!Schema::hasTable('rule_dependencies')) {
            Schema::create('rule_dependencies', function (Blueprint $table): void {
                ...
                $table->unique(['business_rule_id', 'dependency_type', 'dependency_key'], 'rule_dep_rule_type_key_uq');
            });
        }
    }
